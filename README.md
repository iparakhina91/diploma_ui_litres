...
Проект направлен на тестирование пользовательского интерфейса сайта компании Litres [litres.com](https://litres.com), которая является крупнейшим представителем рынка электронных книг и аудиокниг.  

Разработанная тестовая документация охватывает функциональность <code>Поиска книг</code>. 
...
- тестовые данные сгенерированы с помощью библиотеки `Java Faker`
