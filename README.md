...
Проект направлен на тестирование пользовательского интерфейса сайта компании litres.com [litres.com](https://litres.com), которая является крупнейшим представителем рынка электронных книг и аудиокниг.  
Разработанная тестовая документация охватывает функциональность поиска книг. 
